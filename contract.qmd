...
tasks = tribble(
  ...
  "Q1 Prep Code",           NULL,                           "Nov 20",
  "Q1 Visualizations",      NULL,                           "Nov 20",
  "Q2 Prep Code",           NULL,                           "Nov 20",
  "Q2 Visualizations",      NULL,                           "Nov 20",
  "Presentation",           NULL,                           "Dec 9",
  "Dashboard",              "Bryan",                        "Dec 9",
  "Report",                 NULL,                           "Dec 9"
)
```
